          ...
          <section className=" pb-16">
            <div className="py-2 custom-container ">
              ...
              <div className=" py-4">
                <Link
                  href={resource.url}
                  className="bg-accent h-auto py-2 px-4 text-sm text-white rounded-xl font-bold hover:bg-darkaccent hover:text-white duration-150 flex items-center gap-1 w-fit"
                >
                  Download
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
